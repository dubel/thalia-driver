...
- Orthogonal tiles only: `Cube.001` at joins, `Cube` on spans. Lamps: sidewalk grass, skip crossings. Lamps have a thin AABB. Block buildings are untextured instanced boxes inset from the curb, no shadows.
